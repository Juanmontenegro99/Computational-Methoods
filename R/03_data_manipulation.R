...
for (i in 1:length(files_path)) {
  ...
  assign(file_names[i], data) # Le asigna un nombre de variable a un dato
}
...
# Pero no siempre debe ser factors puede ser lo que sea siempre que sea lo mismo
...
# los 2 2puntos es como el paquete.funcion de python y esta función voltea y te replica el factor
